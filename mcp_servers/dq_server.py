...
Every tool is wrapped in error handling — a bad table/column name
returns a clean "ERROR: ..." string instead of crashing the server.
...
def count_rows(table: str) -> str:
    ...
    try:
        ...
        return f"ERROR: could not query table '{table}' — {e}"
    except Exception as e:
        return f"ERROR: unexpected failure querying '{table}' — {e}"
...
def check_nulls(table: str, column: str) -> str:
    ...
    try:
        ...
        return f"ERROR: could not check nulls on '{table}.{column}' — {e}"
    except Exception as e:
        return f"ERROR: unexpected failure checking nulls — {e}"
...
def check_duplicates(table: str, key_columns: str) -> str:
    ...
    try:
        ...
        return f"ERROR: could not check duplicates on '{table}' — {e}"
    except Exception as e:
        return f"ERROR: unexpected failure checking duplicates — {e}"
...
def check_freshness(table: str, timestamp_column: str = "order_purchase_timestamp") -> str:
    ...
    try:
        ...
        return f"ERROR: could not check freshness on '{table}.{timestamp_column}' — {e}"
    except Exception as e:
        return f"ERROR: unexpected failure checking freshness — {e}"
